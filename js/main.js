...
btnText.addEventListener('click', function(){
    ...
    'Truth: Nếu bạn đổi giới tính một ngày bạn sẽ làm gì <br>Dare: Gọi cho bố mẹ nói "tối nay con không về nhà" dập máy luôn',
    ...
    'Truth: Bạn ghét ai nhất trong đây <br>Dare: Tỏ tình với cr của bạn đi nàoo',
